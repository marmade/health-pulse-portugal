...
**Data:** 18/09/2026 · **Estado:** ESBOÇO. Nada disto está na página. Voz: primeira pessoa
(Marta). Profundidade: "para eles terem uma ideia do que aconteceu" — o essencial em três
...
```
 ...
 1028         26           2            0            3            6            88 commits
                          ...
                          │ continuou a correr sozinho — e, como descobri em Setembro,
...
que eu julgava, e que um quarto da lista não tinha procura com aquela formulação.
...
Foi o dia em que percebi porque é que os gráficos nunca tinham batido certo. O Google
Trends publica um índice de 0 a 100 em que **100 é o ponto mais alto da descarga que se
fez** — não há contagens. Descarreguei `menopausa` sozinha: máximo 100. Descarreguei-a com
...
um termo comum a ligar as réguas. Escolhi uma **âncora por eixo**, com critérios escritos
...
No mesmo dia testei a categoria "Saúde" do Google, que sempre tinha usado para filtrar
...
sem ele — as pessoas escrevem `psicologa`, sem acento e no feminino. Decidi manter o filtro
e escrevê-lo como **limitação**: os valores são "pesquisas que o Google classificou como
Saúde", não "pesquisas sobre saúde".

A lista de palavras-chave saiu deste dia refeita. Li cinco corpos de dados — quase duas mil
pesquisas relacionadas, as sondas que fiz à mão, a categoria Saúde sem termo — e a lista
passou a ter **duas colunas: o termo institucional** (DGS, SNS 24, CUF) **e o termo que as
pessoas escrevem**. Das 82, 61 ficam (28 reformuladas: `PTSD` → `stress pós-traumático`,
...
parada desde Agosto — um termo que passava de 1 para 2 dava "+100 %". Escrevi uma regra e
corri-a sobre cinco anos de dados antes de a ligar: esta semana contra a mediana das oito
...
da diabetes, as tempestades de Janeiro (porque `depressão` mede tempestades, e a regra não
o esconde). E descobriu-se pelo caminho que **só 17 dos 84 termos têm procura regular**: a
lista nova existe também por causa deste número.

---

## C. Os outros marcos — só o essencial, para veres a escala
...
eram minhas desde o início — de fontes oficiais, DGS, SNS 24 e CUF.
...
trás. *Descobriu-se* que as duas divergiam e porquê. *Mudou:* a instância nova passa a
...
suposição" passa a valer para tudo o que o dashboard mostra.
