...
const fallbackModals: Record<string, { eyebrow: string; title: string; text: string }> = {
  ...
  site: { eyebrow: "Ecossistema Digital", title: "Site", text: "O arquivo público do projecto. Arquiva todos os conteúdos (vídeos, textos e verificações) produzidos. Expõe conteúdos do https://www.sns24.gov.pt/pt/info-saude do SNS mas de uma forma mais dinâmica. O que é distribuído pelas redes sociais tem sempre o site como destino e fonte original. O próprio site serve como veículo para chegar a instituições e repositórios na área de ciências da saúde." },
  app: { eyebrow: "Ecossistema Digital", title: "Diz que Disse", text: "Serve como uma arma de bolso científica, que corre nos telemóveis e arquiva a revisão de pares. Permite ao utilizador pesquisar temas e aceder a respostas com fundamento científico em qualquer circunstância." },
  ...
  return (
    <div className="min-h-screen text-foreground" style={{ backgroundColor: "#F5F5FF" }}>
      ...
      <section className="px-6 py-12 flex flex-col items-center">
        ...
        <DiagramBox label="Reportagem Viva" id="reportagem" style={S.digital} onClick={open} />
